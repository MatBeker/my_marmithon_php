    ...
    <section class="well" id="result_search">
        <div class="container">
            ...
            <div class="gallery">
                ...
                while (isset($data_adv[$i]["id"])) {
                    echo '
                            <br><br>
                                <div>
                                    <img src="images/img-recette/' . $data_adv[$i]["name_img"] . '"class="img_search" alt="">
                                    <p style="text-align: center;"><em>' . $data_adv[$i]["name"] . '</em></p>
                                    <div class="decoration">
                                        <a href="../controler/php/details_controller.php?id='.$data_adv[$i]["id"].'" class="mybtn">Voir plus</a>
                                    </div>
